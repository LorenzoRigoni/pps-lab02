...
object Optionals:
  ...
  object Optional:
    ...
    /**
     * filter applies a function that keeps the value (if present, otherwise the output is None) only if it satisfies the given predicate.
     * Example:
     *
     ...
     * @param f the function to apply to the value of the optional
     * @tparam A The type of the optional
     * @return if present, the value only if it satisfies the given predicate, Empty otherwise
     */
